    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2">Faction Locker Logs</span>
            </div>
        </li>
    </ol>
</div>
...
<div class="mt-8">
    <h2 class="text-white text-xl font-semibold mb-4">Faction Locker Logs</h2>

    <!-- Search Form -->
    <form method="GET" action="{{ route('faction.lockerlogs') }}" class="mb-4">
    ...
    @if ($logs->isEmpty())
        <div class="text-gray-300 italic text-sm">No locker logs found for this faction.</div>
    @else
