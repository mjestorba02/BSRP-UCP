                            ...
                            <tr class="hover:bg-red-900 transition duration-150">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex flex-col space-y-1 items-center justify-center">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p class="text-sm text-gray-200 mb-6">
                                                        Are you sure you want to remove this member from your gang?
                                                    </p>
                                                    ...
                                                    <div class="flex justify-center gap-4">
                                                        ...
                                                        <form 
                                                            action="{{ route('gang.kick', $member->uid) }}" 
                                                            method="POST"
                                                        >
                                                            @csrf
                                                            @method('DELETE')
                                        ...
                                        @if ($user->gangrank == 6 && $member->uid !== $user->uid)
                                            @if (!$member->glockerl)
                                                <form action="{{ route('gang.giveLocker', $member->uid) }}" method="POST">
                                                    @csrf
                                            ...
                                            @else
                                                <form action="{{ route('gang.revokeLocker', $member->uid) }}" method="POST">
                                                    @csrf
