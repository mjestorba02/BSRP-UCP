    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2">Admin Command Logs</span>
            </div>
        </li>
    </ol>
</div>
...
<div class="mt-8">
    <h2 class="text-white text-xl font-semibold mb-4">Admin Command Logs</h2>

    <!-- Search Form -->
    <form method="GET" action="{{ route('admin.admincmdlogs') }}" class="mb-4">
    ...
    @if ($logs->isEmpty())
        <div class="text-gray-300 italic text-sm">No admin command logs found.</div>
    @else
