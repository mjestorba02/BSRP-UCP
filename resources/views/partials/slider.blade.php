<section class="slider_section">
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      @foreach ([
          ['Live', 'Your Story', 'in Los Santos', 'rp1.png', '#joinnow'],
          ['Shape', 'Your Fate', 'One Decision at a Time', 'rp2.png', '#features'],
          ['Rise', 'Through Ranks', 'Earn Respect', 'rp3.png', '#careers'],
          ['Join', 'A City', 'That Never Sleeps', 'rp4.png', '#about']
      ] as $index => $slide)
